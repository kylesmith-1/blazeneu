defmodule ECompanyTestWeb.EventControllerTest do
  use CompanyTestWeb.ConnCase

  alias CompanyTest.Events
  alias EveCompanyTestntsApp.Events.Event

  @create_attrs %{
    body: "some body",
    date: "some date",
    event_title: "some event_title"
  }
  @update_attrs %{
    body: "some updated body",
    date: "some updated date",
    event_title: "some updated event_title"
  }
